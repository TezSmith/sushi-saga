...
1. How would we prevent people from being able to purchase sushi after it's already been eaten?
2. SushiWallet! Add a form for customers to add more money to their balance
3. Full rotation! When the end of the line of sushi is reached, the conveyor belt should start from the beginning. Sushi that have already been eaten should remain eaten. It would be creepy if they reappeared!
